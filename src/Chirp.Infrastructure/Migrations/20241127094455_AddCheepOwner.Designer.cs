...
namespace Chirp.Infrastructure.Migrations
{
    ...
    [Migration("20241127094455_AddCheepOwner")]
    partial class AddCheepOwner
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Chirp.Core.Entities.Cheep", b =>
                {
                    ...
                    b.HasIndex("CheepOwnerId");

                    b.ToTable("Cheeps");
                });

            modelBuilder.Entity("Chirp.Core.Entities.CheepLike", b =>
                {
                    b.Property<int>("LikedCheepsId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("LikedCheepsId", "LikesId");
            ...
            modelBuilder.Entity("Chirp.Core.Entities.Cheep", b =>
                {
                    ...
                    b.HasOne("Chirp.Core.Entities.Cheep", "CheepOwner")
                        .WithMany("Comments")
                        .HasForeignKey("CheepOwnerId");

                    b.Navigation("Author");

                    b.Navigation("CheepOwner");
                });
